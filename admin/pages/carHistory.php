 ...
 ?>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Car Rental History</h1>
                </div>
...
if(isset($_SESSION['id'])){
   // include database connection
	...
	// SELECT query
        $query = "SELECT DISTINCT reservation.carID, make_model, year, vin, name, reservation.memberID, date FROM reservation NATURAL JOIN car, member WHERE reservation.memberID = member.memberID ORDER BY carID";
        ...
        // Execute the query
		$stmt->execute();
        $stmt->bind_result($carID,$makemodel,$year,$vin,$name,$memberID,$date);
