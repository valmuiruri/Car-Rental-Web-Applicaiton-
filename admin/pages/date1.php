 ...
 ?>
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="location3.php">300University Ave.</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Check Reservations</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
            <form name='chooseday' id='chooseday' action='date1.php' method='post'>
			...
			<div class="etc-login-form">
				<input type="submit" id='chooseday' name='chooseday' value='Submit' class="btn btn-default"/>
			</div>
                </div>
                    </form>
...
if(isset($_SESSION['id'])){
    ...
    if (isset($_POST['chooseday'])){
        ...
        $query = "SELECT reservation.carID, memberID, make_model, year, vin FROM reservation NATURAL JOIN car WHERE '".$_POST["day"]."' >= date AND '".$_POST["day"]."' <= DATE_ADD(date, INTERVAL length_of_reservation DAY)";
        ...
        // Execute the query
        $stmt->execute();
        $stmt->bind_result($carID, $memberID,$makemodel,$year,$vin);
        echo "<h2>Reservations on ", $_POST['day'], ":</h2>";
