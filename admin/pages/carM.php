 ...
 ?>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Car Maintenance</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
				...
				<!-- SQL for damaged and cars that need repair -->
				<div class="col-lg-4 col-md-4">
					<h3>Damaged cars that should be repaired</h3>
					<?php
						...
						// SELECT query
						$query = "SELECT member_history.carID, make_model, year, vin, return_stat FROM member_history NATURAL JOIN car WHERE return_stat = 'damaged' ";
						...
						// Execute the query
						$stmt->execute();
						$stmt->bind_result($carID, $make_model,$year,$vin,$return_stat);
					...
					while ($stmt -> fetch()) {
						...
						echo "<td>$vin</td>";
						echo "<td>$year </td>";
						echo "<td>$make_model</td>";
						echo "<td>$return_stat </td>";
						echo "</tr>";
			...
			?>
				...
				<div class="col-lg-4 col-md-4">
					<h3>Cars that are flagged to be repaired</h3>
					<?php
if(isset($_SESSION['id'])){
   // include database connection
    include_once '../../connection.php'; 
	...
	// SELECT query
        $query = "SELECT member_history.carID, make_model, year, vin, return_stat FROM member_history NATURAL JOIN car WHERE return_stat = 'not running'";
