 ...
 ?>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">300 University Ave.</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
if(isset($_SESSION['id'])){
   // include database connection
	...
	// SELECT query
        $query = "SELECT carID, vin, make_model, year, rental_fee FROM car WHERE pickup_location = '300 University Ave.' AND available = '0'";
...
if(isset($_SESSION['id'])){
    include_once '../../connection.php';
    echo "<br>";   
    echo "Reservation for cars at 300 University Ave: <br>";
    
    $query = "SELECT car.carID, vin, make_model, year, rental_fee, memberID AS reserved_by FROM car, reservation WHERE pickup_location = '300 University Ave.' AND available = '1' AND reservation.carID = car.carID";
    ...
    if ($stmt -> fetch()){
        ...
        echo "No cars are reserved at 300 University Ave. currently. <br>";
    }
    echo "</table>";
}
?> 
